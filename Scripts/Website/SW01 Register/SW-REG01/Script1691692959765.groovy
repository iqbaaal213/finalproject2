...
WebUI.setText(findTestObject('Web - Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_Tanggal lahir_birth_date'), 
    GlobalVariable.tanggal_lahir)

WebUI.setText(findTestObject('Web - Register/Page_Buat akun dan dapatkan akses di Coding.ID/input_E-Mail_email'), 'ga2k22t@ezztt.com')
